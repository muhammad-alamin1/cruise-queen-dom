...
document.getElementById('case-increment-Economy').addEventListener('click', function () {
    EconomyticketHandel(true);

});
document.getElementById('case-decrement-Economy').addEventListener('click', function () {
    EconomyticketHandel(false);
